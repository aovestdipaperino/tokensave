...
def probes_for(d):
    ...
    return {
        ...
        "tokensave_hotspots":          [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_complexity":        [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_dead_code":         [{}, {"limit": 10}, {"include_public": False},
                                        {"path": "src"}, {"path": "lib"}],
        "tokensave_circular":          [{}, {"limit": 5}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_doc_coverage":      [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": files[0]}],
        "tokensave_god_class":         [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_dependency_depth":  [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_inheritance_depth": [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_distribution":      [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tokensave_gini":              [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tokensave_largest":           [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_recursion":         [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_coupling":          [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": files[0]}],
        "tokensave_dsm":               [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tokensave_module_api":        [{"path": f} for f in files],
        "tokensave_simplify_scan":     [{"files": [f]} for f in files],
        "tokensave_unused_imports":    [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_test_map":          [{"file": f} for f in files],
        "tokensave_test_risk":         [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_todos":             [{}, {"limit": 10}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}],
        "tokensave_files":             [{}, {"path": "src"}, {"path": "lib"}, {"path": "tests"}, {"path": "dist"}],
        "tokensave_status":            [{}] * 5,
        "tokensave_health":            [{}] * 5,
        "tokensave_diagnose":          [{"cargo_output": "TypeError: undefined is not a function at src/lib.js:1:5"}] * 5,
        # port
